...
const optionalSousRayonSchema = z.preprocess(
  (value) => {
  ...
  z.string().min(2, 'Le sous-rayon doit comporter au moins 2 caractères').optional()
);
...
export const createRayonSchema = z.object({
  code: z
    ...
    .regex(/^[A-Z0-9\-]+$/, 'Le code doit être en majuscules (ex: RAY-SF)'),
  libelle: z
  ...
  sousRayon: optionalSousRayonSchema,
});
